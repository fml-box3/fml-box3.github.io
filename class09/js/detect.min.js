(function (e) {
			...
			d = function (e) {
				...
				return (
					...
					l(e) &&
						l(e.major) &&
						((r += e.major),
						l(e.minor) && ((r += "." + e.minor), l(e.patch) && (r += "." + e.patch))),
					r
				);
			},
			c = function (e) {
		...
		return (
			(e.parse = function (r) {
				...
				(s.source = r),
					(s.browser = i(r, t)),
					l(s.browser)
						? ((s.browser.name = c(s.browser)), (s.browser.version = d(s.browser)))
						: (s.browser = {}),
					(s.os = i(r, m)),
					l(s.os) ? ((s.os.name = c(s.os)), (s.os.version = d(s.os))) : (s.os = {}),
					(s.device = i(r, p)),
					l(s.device)
						? ((s.device.name = c(s.device)), (s.device.version = d(s.device)))
	...
	"undefined" != typeof exports
		? ("undefined" != typeof module && module.exports && (exports = module.exports = r),
		  (exports.detect = r))
		: (e.detect = r),
